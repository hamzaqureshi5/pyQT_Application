...
class PreviewOutput(QDialog):  # testing purpose only
    ...
    def __init__(self,dataframe_elect,dataframe_graph,elect_labels:bool,graph_labels:bool):
        super().__init__()
        self.ui = Ui_Dialog()
...
#dataframe_elect = pd.read_csv("demo2.csv")
#dataframe_laser = pd.read_csv("demo2.csv")

#w = previewOutputWin(dataframe_laser,dataframe_elect,True,True)
#w.show()
#app.exec()
